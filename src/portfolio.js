...
const projectsHeader = {
  title: "Projects",
  description:
    "I always try to use the latest technologies in my projects, My websites always get the best scores in performance, accessibility and seo, I'm comfortable converting desgins to fully responsive and pixel perfect websites with high page speed performance",
